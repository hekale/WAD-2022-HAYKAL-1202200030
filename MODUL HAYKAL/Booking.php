    ...
    <div class="container" style="border: 1px solid rgb(228,228,228); max-width : 78%; border-radius : 5px">
                <div class="row">
                    <div class="col">
                        <?php
                         if(isset($_GET['mobil'])){
                            if($_GET['mobil']=='alphardx'){
                            echo '<img width="400" height="250" src=/Alphard.jpg></img>';
                            }
                            elseif($_GET['mobil']=='mobiliox'){
                                echo '<img width="400" height="250" src=/Mobilio.jpg></img>';
                            }
                            elseif($_GET['mobil']=='avanzax'){
                              echo '<img width="350" height="250" src=/Avanza.jpg></img>';
                            }
                         }
                            else{
                            echo '<img width="350" height="250" src=image></img>';
                            }
                        ?>
                    </div>
                </div>
